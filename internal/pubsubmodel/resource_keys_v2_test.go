...
func TestResourceKeysV2MapPubSubGraphToCanonicalFamilies(t *testing.T) {
	...
	cases := map[string]string{
		...
		keys.PublisherGroup("publisher-group:1"):        "dev-safe:logma:pubsub:publisher-group:publisher-group%3A1",
		keys.PublisherGroupPublishers("publisher-group:1"): "dev-safe:logma:pubsub:publisher-group:publisher-group%3A1:publishers",
		...
		keys.Publishers():                               "dev-safe:logma:pubsub:registry:publishers",
		keys.SubscriptionGroups():                       "dev-safe:logma:pubsub:registry:subscription-groups",
		keys.PublisherGroups():                          "dev-safe:logma:pubsub:registry:publisher-groups",
	}
